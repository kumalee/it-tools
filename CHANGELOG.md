...
## Version 2023.11.27-350a7fe

### Features
- **tauri**: add tauri to wrap it-tools as a app (9944025)
...
### Bug fixes
-  show message for camera-recoder not supported in Tauri app (2c68dd6)
-  add shell-open to tauri allowlist to support open remote link (0fe92a8)
...
### Chores
- **tauri**: update release script for update version for tauri (350a7fe)
-  replace tauri default icon with it-tools icon for desktop version (66aa977)
-  update ci and release workflow for tauri build (72ce745)
